...
#$compiler_bin/riscv64-unknown-elf-gcc -I../ -I${common}/env -I${common}  $RISCV_GCC_OPTS ${common}/syscalls.c $common/crt.S -T ${common}/test.ld $sources -lm -lgcc -o $bin  -DPITON_NUMTILES=$1 
