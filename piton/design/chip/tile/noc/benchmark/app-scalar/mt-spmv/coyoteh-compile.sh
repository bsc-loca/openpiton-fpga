...
$compiler_bin/riscv64-unknown-elf-gcc -I../ -I${common}/env -I${common} -I/usr/include/ -DPREALLOCATE=1 -mcmodel=medany -static -std=gnu99 -O2 -ffast-math -fno-common -fno-builtin-printf -march=rv64g ${common}/syscalls.c ./my_crt.S -static -nostdlib -nostartfiles -T ${common}/test.ld mt-spmv.c spmv.c -o $bin
