...
if {[info exists ::env(PROTOSYN_RUNTIME_HBM)] &&
  ...
  connect_bd_net [get_bd_pins gndx32/dout] [get_bd_pins hbm_0/AXI_31_WDATA_PARITY] [get_bd_pins hbm_0/AXI_01_WDATA_PARITY] [get_bd_pins hbm_0/AXI_02_WDATA_PARITY]
